...
try {
    ...
    System.out.println("Error reading color sensor in hasGamePieceEntered: " + e.getMessage());
    return false;
}
    }
    ...
    public boolean hasGamePieceExited() {
        ...
        try {
            ...
            System.out.println("Error reading color sensor in hasGamePieceExited: " + e.getMessage());
            return false;
        }
    }
