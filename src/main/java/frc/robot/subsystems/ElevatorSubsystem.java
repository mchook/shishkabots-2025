...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private static final double TOP_THRESHOLD = 27.5;  // Adjust based on actual max height
    
    // Predefined heights in encoder units
    private static final double LEVEL_0_HEIGHT = 0.0;   // Bottom level (home position)
    private static final double LEVEL_1_HEIGHT = 5.9;  // First level
    private static final double LEVEL_2_HEIGHT = 14.4;  // Mid level
    private static final double LEVEL_3_HEIGHT = 26.5;  // Top level
